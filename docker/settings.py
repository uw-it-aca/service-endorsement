...
RESTCLIENTS_MSCA_OAUTH_TOKEN_URL = os.getenv(
    "RESTCLIENTS_MSCA_OAUTH_TOKEN_URL"
)
RESTCLIENTS_MSCA_REPORT_SCOPE = os.getenv("RESTCLIENTS_MSCA_REPORT_SCOPE")
RESTCLIENTS_MSCA_CLIENT_ID = os.getenv("RESTCLIENTS_MSCA_CLIENT_ID")
RESTCLIENTS_MSCA_SUBSCRIPTION_KEY = os.getenv(
    "RESTCLIENTS_MSCA_SUBSCRIPTION_KEY"
)
RESTCLIENTS_MSCA_CLIENT_SECRET = os.getenv("RESTCLIENTS_MSCA_CLIENT_SECRET")
